...
try:
    ...
    st.error("API Anahtarı bulunamadı veya kasaya eklenmemiş.")
...
if submit:
    if not email or "@" not in email:
        ...
        with st.spinner("Sistemik alan taranıyor, köklerinizdeki kayıtlar hesaplanıyor..."):
            ...
            try:
                # GÜÇLENDİRİLMİŞ SİSTEMİK PROMPT
                prompt_metni = f"""
                ...
                1. FALCI DİLİNDEN KAÇIN: "Sen şöylesin" deme. Bunun yerine sistemik dinamikleri açıkla.
                2. SİSTEMİK ODAK: "Aidiyet", "Hiyerarşi", "Dolaşıklık", "Dışlanmış Atalar" kavramlarını kullan.
                3. DİL: Kesinlikle İngilizce kelime kullanma. Tamamen Türkçe olsun.
                4. FORMAT: SADECE JSON ver.
                
                JSON Yapısı:
                {{
                    "isik": ["Sistemik Güç 1", "Sistemik Güç 2"],
                    "golge": ["Ruhsal Yük 1", "Ruhsal Yük 2"],
                    "analiz": "Buraya en az 4-5 cümlelik, sarsıcı ve karakter analizi değil SİSTEMİK analiz paragrafı yaz.",
                    "soru": "Atalarına sorman gereken derin bir soru.",
